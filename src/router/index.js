...
const Routers = new Router({
    ...
    routes: [
        ...
        },
        {
            path: '/home',
            name: '首页',
            component: resolve => require(['@/views/settings/layout/layout'], resolve),
            children: [
                {
                    path: 'workbench/debug',
                    name: '流程调试',
                    component: resolve => require(['@/views/workbench/debug/list'], resolve)
                },
                {
                    path: 'workbench/deployment',
                    name: '流程定义',
                    component: resolve => require(['@/views/workbench/deployment/list'], resolve)
                },
                {
