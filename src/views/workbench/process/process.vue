                ...
                <el-table-column fixed="right" label="操作">
                    <template slot-scope="scope">
                        <el-button type="text" size="small"
                                   @click="getDiagramByDefinitionId(scope.row.processDefinitionId)"
                                   v-if="form.finished == true">查看流程
                        </el-button>
                        <el-button type="text" size="small" @click="getDiagramByInstanceId(scope.row.id)"
                                   v-if="form.finished == false">查看流程进度
                        </el-button>
                        <el-button type="text" size="small" v-if="!form.finished"
                                   @click="turnToTask(scope.row.businessKey)">进入办理
                        </el-button>
                        <el-button type="text" size="small" v-if="!form.finished"
                                   @click="cancelProcessInstance(scope.row.id)">取消流程
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
